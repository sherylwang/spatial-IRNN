...
template <typename Dtype>
void RNNRIGHTLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void RNNRIGHTLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(RNNRIGHTLayer);
}  // namespace caffe
